...
## `height` vs. `earn`
ggplot(heights_df, aes(x = height, y = earn)) + geom_smooth() + geom_point()
## `age` vs. `earn`
ggplot(heights_df, aes(x = age, y = earn)) + geom_smooth() + geom_point()
## `ed` vs. `earn`
ggplot(heights_df, aes(x = ed,y = earn)) + geom_smooth() + geom_point()
