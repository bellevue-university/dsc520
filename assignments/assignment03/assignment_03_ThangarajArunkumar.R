...
setwd("C:/Users/arun8/R/dsc520_fork")
...
geom_point() + labs(x = "Height (Inches)", y = "Earnings (Dollars)", title = "Height vs. Earnings")

ggplot(heights_df, aes(x=height, y=earn, col=sex)) + 
geom_point() + xlab("Height (Inches)") + ylab("Earnings (Dollars)")+ggtitle("Height vs. Earnings")

## https://ggplot2.tidyverse.org/reference/geom_histogram.html
## Create a histogram of the `earn` variable using `geom_histogram()`
ggplot(heights_df, aes(earn)) + geom_histogram(colour="Blue", fill="black")

## Create a histogram of the `earn` variable using `geom_histogram()`
## Use 10 bins
ggplot(heights_df, aes(earn)) + geom_histogram(colour="Blue", fill="black",bins=10)

# https://ggplot2.tidyverse.org/reference/geom_density.html
## Create a kernel density plot of `earn` using `geom_density()`
ggplot(heights_df, aes(earn)) + geom_density(color="darkblue", fill="lightblue")
