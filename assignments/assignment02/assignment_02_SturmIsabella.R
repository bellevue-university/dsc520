...
## Use `setwd()` if needed
## setwd("/home/jdoe/Workspaces/dsc520") ## Didn't need to do because I am already in the correct directory
...
voter_turnout_df2 <- read_excel('data/G04ResultsDetail2004-11-02.xls', sheet='Voter Turnout', skip=2, 
                                col_name=c("ward_precint","ballots_cast", "registered_voters", "voter_turnout"))
