...
## In R 4.0.0. default.stringsAsFactors() is False. So, creating person_df11 to consider string as factors
person_df1 <- read.csv(file = 'data/tidynomicon/person.csv')
str(person_df1)

person_df11 <- read.csv(file = 'data/tidynomicon/person.csv', stringsAsFactors=TRUE)
str(person_df11)
