...
week1_sleep <-c(monday=6.1, tuesday=8.8, wednesday=7.7, thursday=6.4, friday=6.2, saturday=6.9, sunday=6.6)
week1_sleep
...
week2_sleep <-c(monday=7.1, tuesday=7.4, wednesday=7.9, thursday=6.5, friday=8.1, saturday=8.2, sunday=8.9)
week2_sleep
...
days <- c(sunday=1,monday=2,tuesday=3,wednesday=4,thursday=5,friday=6,saturday=7)
days
