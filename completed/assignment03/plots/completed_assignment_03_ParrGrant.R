...
heights_df <- read.csv(file = "/Users/gparr/dsc520/data/r4ds/heights.csv")
heights_df
...
ggplot(data=heights_df, aes(x=height, y=earn, col=sex)) + geom_point() + ggtitle("Height vs. Earnings") +
