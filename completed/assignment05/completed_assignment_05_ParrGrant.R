...
spurious_correlation<- data.frame(tech_spending, suicides)
View(spurious_correlation)

cor(spurious_correlation$tech_spending, spurious_correlation$suicides)
ggplot(spurious_correlation, aes(tech_spending, suicides)) + geom_point()
