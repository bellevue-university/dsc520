...
names(week1_sleep_weekdays) <- c("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday")
...
students_combined
grades <- matrix(students_combined, byrow = TRUE, nrow = 3, ncol = 2)
grades
...
recommendations_vector <- factor(c(recommendations_vector))
                            levels = c("no", "neutral", "yes")
                            ordered = TRUE
factor_recommendations_vector <- ordered(recommendations_vector)
