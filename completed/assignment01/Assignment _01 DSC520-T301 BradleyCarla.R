...
print (total_sleep_week2 < total_sleep_week1)

## Calculate the mean hours slept in week 1 using the `mean()` function
total_sleep_week1 <- c(6.1, 8.8, 7.7, 6.4, 6.2, 6.9, 6.6)
...
assignment4 <- c(92.1, 84.3, 75.1, 97.8)
grades <- cbind(grades, c(assignment4))
grades
