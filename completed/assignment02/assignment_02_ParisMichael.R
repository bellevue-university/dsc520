...
scores_df <- read.csv(file='scores.csv', stringsAsFactors = FALSE)
summary(scores_df)
...
columnNames <- c("ward_precint", "ballots_cast", "registered_voters", "voter_turnout")
voter_turnout_df2 <- read_excel('G04ResultsDetail2004-11-02.xls', sheet='Voter Turnout',skip=2, col_names = columnNames)
