...
person_df1 <- read.csv("data/tidynomicon/person.cvs", stringsAsFactors = TRUE)
string(person_df1)
...
person_df2 <- read.csv("data/tidynomicon/person.cvs", stringsAsFactors = FALSE)
str(person_df2)
