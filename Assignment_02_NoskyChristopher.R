...
person_df1 <- read.csv('c:/Users/cwnos/Documents/DSC520/Git repo/DSC520/dsc520/data/tidynomicon/person.csv', stringsAsFactors = TRUE)
str(person_df1)
...
person_df2 <- read.csv('c:/Users/cwnos/Documents/DSC520/Git repo/DSC520/dsc520/data/tidynomicon/person.csv', stringsAsFactors = FALSE)
str(person_df2)
...
voter_turnout_df2 <- read_excel('data/G04ResultsDetail2004-11-02.xls',sheet = 'Voter Turnout',
                                skip = 2, col_names = c('ward_precint', 'ballots_cast', 'registered_voters', 'voter_turnout'))
